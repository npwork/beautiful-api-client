...
export class PostsApiService extends BaseService {
  ...
  @POST('/')
  @FormUrlEncoded
  formUrlEncoded(@Field('userId') userId: number, @Field('title') title: string, @Field('body') body: string): ApiResponse<Post> {}
  ...
  @POST('/')
  field(@Field('userId') userId: number, @Field('title') title: string, @Field('body') body: string): ApiResponse<Post> {}
...
export class ResponseBodyPostsApiService extends BaseService {
  ...
  @POST('/')
  @FormUrlEncoded
  formUrlEncoded(@Field('userId') userId: number, @Field('title') title: string, @Field('body') body: string): ApiResponseBody<Post> {}
  ...
  @POST('/')
  field(@Field('userId') userId: number, @Field('title') title: string, @Field('body') body: string): ApiResponseBody<Post> {}
