import { ErrorMessages, BeautifulApiClient } from '../../../src'
...
describe('Decorators - wrong cases', () => {
  describe('Headers', () => {
    ...
    beforeAll(() => {
      service = new BeautifulApiClient(testServer.url).build(WrongHeaderService)
    })
  ...
  describe('Fields', () => {
    ...
    beforeAll(() => {
      service = new BeautifulApiClient(testServer.url).build(WrongFieldService)
    })
  ...
  describe('Multipart', () => {
    ...
    beforeAll(() => {
      service = new BeautifulApiClient(testServer.url).build(WrongMultipartService)
    })
  ...
  describe('Query params', () => {
    ...
    beforeAll(() => {
      service = new BeautifulApiClient(testServer.url).build(WrongQueryService)
    })
  ...
  describe('No Http decorator', () => {
    ...
    beforeAll(() => {
      noHttpMethodService = new BeautifulApiClient(testServer.url).build(NoHttpMethodService)
    })
  ...
  test('__getLastRequest - empty', async () => {
    const anyService = new BeautifulApiClient(testServer.url).build(NoHttpMethodService)
    await verifyErrorThrown(async () => {
