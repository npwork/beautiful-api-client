...
export const testServerUrl = (address: AddressInfo | string | null) => `http://localhost:${(address as AddressInfo).port}`
...
export function verifyBody<T>(response: AxiosResponse<T>, expectedRequestBody: T, expectedResponseBody = expectedRequestBody) {
