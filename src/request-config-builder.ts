...
import { AxiosRequestConfig, AxiosRequestHeaders, AxiosRequestTransformer, AxiosResponseHeaders } from 'axios'
import { DataResolverFactory } from './dataResolver'
import { BeautifulApiClient } from './beautifulApiClient'

export function makeConfig(
  metadata: MethodMetadata,
  serviceBuilder: BeautifulApiClient,
  methodName: string,
  url: string,
  method: HttpMethod,
...
function getLoggerAfterTransformer(config: AxiosRequestConfig, serviceBuilder: BeautifulApiClient) {
