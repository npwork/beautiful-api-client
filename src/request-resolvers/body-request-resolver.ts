...
export const requestBodyResolver = (metadata: MethodMetadata, methodName: string, headers: AxiosRequestHeaders, args: unknown[]): DataType => {
...
// @Body
function resolveBody(bodyIndex: number | undefined, args: unknown[], data: DataType | DataType[]): DataType | DataType[] {
...
// @Field
const resolveField = (metadata: MethodMetadata, args: unknown[], data: DataType | DataType[]): DataType | DataType[] => {
...
// @MultiPart
const resolveMultipart = (metadata: MethodMetadata, args: unknown[], data: DataType | DataType[]): DataType | DataType[] => {
...
// @FieldMap
const resolveFieldMap = (fieldMapIndex: number | undefined, args: unknown[], data: DataType | DataType[]): DataType | DataType[] => {
